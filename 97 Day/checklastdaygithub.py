...
class CheckLastDayGitHubBot():
    ...
    def send_sms_github(self, commit_level):
        ...
        try:
            ...
            if commit_level == 0:
                body_message = "Vamos lá, Thiago, voce consegue codar alguma coisinha hoje!"
            elif commit_level == 1:
                body_message = "Muito bom, Thiago, objetivo diário alcançado!"
            elif commit_level > 1:
                body_message = "Excelente, Thiago! Vamos que vamos que o céu é o limite!"
            else:
